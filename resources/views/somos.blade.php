    ...
    <div id="carousel-id" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item">
                ...
                <img  alt="First slide" class="img-banner"  src="{{ url('img/banner/about/1.png') }}">
                <div class="container">
...
<br><br><br>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                ...
                <div class="shadow">
                    ...
                    <p class="text-justify px-4 pb-4" style="font-size:1.2em;">
                        TRAVELINE T.M.A estará posicionada, entre las cinco mejores organizaciones de transporte y turismo, para el 2028 en el Departamento de Boyacá.
                    </p>
                </div>
            </div>
    ...
    banner();
        ...
        function banner(){
            ...
            if(ancho<=767){
                img = 'img/banner/about/2.jpg';
            }else {
               img = 'img/banner/about/1.jpg'; 
            }
