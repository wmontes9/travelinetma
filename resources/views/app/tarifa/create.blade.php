					                            	...
					                            	<div class="row">
					                            		<div class="form-group col-md-3">
											            	...
											            	<div class="form-group col-md-3">
											            		...
											            		<input type="range" id="minEdad" name="minEdad" min="0" class="form-control" max="100" value="0" oninput="minamount.value=minEdad.value" required>
																<output id="minamount" name="amount" for="minEdad">0</output> años
											            	</div>

											            	<div class="form-group col-md-3">
						                            			<label for="">Edad max</label>
											            		<input type="range" id="maxEdad" name="maxEdad" min="0" class="form-control" max="100" value="0" oninput="maxamount.value=maxEdad.value" required>
