    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <p class="text-justify" style="font-size:1.3em;">
                Disfruta de esta súper línea viajera, que te brinda la oportunidad de participar en varias actividades, realizando un increíble recorrido por diferentes Municipios de Boyacá en un solo día y con un único propósito: que a través del viaje, queden guardadas en tus vivencias las tradiciones milenarias de nuestra tierra. 
                <br>
            ...
            <p style="font-size:1.3em;">...y mucho más por descubir en este super super recorrido.!!!</p>
        </div>
        <div class="col-md-2">
            <ul class="list-group">
